...
export function BlogWarrantyCta() {
  return (
    <div className="mt-16 bg-brand-navy rounded-2xl p-8 text-white text-center">
      <h3 className="text-2xl font-bold mb-2">See if you qualify for a warranty</h3>
      <p className="text-gray-300 mb-6 max-w-xl mx-auto">
        Running your own truck? Answer a few quick questions about your rig and we&apos;ll tell you whether
        extended warranty coverage is likely to fit — then connect you with options.
      </p>
