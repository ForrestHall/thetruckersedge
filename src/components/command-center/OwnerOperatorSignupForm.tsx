...
export function OwnerOperatorSignupForm() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const loginRes = await fetch('/api/owner-operators/login', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        credentials: 'include',
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor="oo-su-name" className="block text-sm font-medium text-gray-700 mb-1">
          Name (optional)
        </label>
        <input
          id="oo-su-name"
      ...
      <div>
        <label htmlFor="oo-su-email" className="block text-sm font-medium text-gray-700 mb-1">
          Email
        </label>
        <input
          id="oo-su-email"
      ...
      <div>
        <label htmlFor="oo-su-password" className="block text-sm font-medium text-gray-700 mb-1">
          Password
        </label>
        <input
          id="oo-su-password"
